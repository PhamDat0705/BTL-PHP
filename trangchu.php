...
<?php
 ...
 ?>
	  ...
	  $query = "select * from tblsanpham limit $from, $sosp1trang";
      ...
      <center><table height="140px" width="250px">    
        <div class="container">
<fieldset>
              <a href="?tem=1&ma=<?php echo($row["ma"]);?>"><img src="<?php echo "anh/".$row["anh"];?>"  class="image" /></a>
              <a href="?tem=1&ma=<?php echo($row["ma"]);?>"><div class="overlay">
<div class="text"><?php echo($row["mota"]);?></div>
		...
		$query = "select * from tblsanpham";
		 ...
		 for($t=1;$t<=$sotrang;$t++)
		 {
			 echo "<a href='main.php?tem=2&trang=$t' style='color:blue; text-decoration:none'>$t&nbsp;&nbsp;</a>";
			 }
	?> 
</body>
</center>
